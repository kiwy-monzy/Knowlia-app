        ...
        if let Some(old_cfg) = crate::storage::configuration::Configuration::load(
            ...
            for user in &old_cfg.user_accounts {
                user_accounts.push(crate::storage::configuration::UserAccount {
                    ...
                    active: true,      // Default to active for upgraded configurations
                    profile_pic: None, // Default to None for upgraded configurations
                    about: None,       // Default to None for upgraded configurations
                    reg_no: None,      // Default to None for upgraded configurations
                    college: None,     // Default to None for upgraded configurations
                });
            }
