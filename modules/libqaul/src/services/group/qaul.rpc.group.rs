...
pub struct Group {
    ...
    #[prost(
        oneof = "group::Message",
        tags = "1, 2, 3, 4, 5, 6, 7, 8, 17, 18, 9, 10, 11, 12, 13, 14, 15, 16"
    )]
...
pub mod group {
    ...
    pub enum Message {
        ...
        GroupDeleteRequest(super::GroupDeleteRequest),
        /// group delete response
        #[prost(message, tag = "18")]
        GroupDeleteResponse(super::GroupDeleteResponse),
        /// group info request
        #[prost(message, tag = "9")]
...
pub struct GroupMember {
    ...
    /// registration number
    #[prost(string, tag = "7")]
    pub reg_no: ::prost::alloc::string::String,
    /// profile picture URL
    #[prost(string, tag = "8")]
    pub profile_pic: ::prost::alloc::string::String,
