...
pub mod rtc_managing;
pub mod rtc_messaging;
...
pub struct RtcSession {
    ...
    #[allow(dead_code)]
    pub user_id: Vec<u8>,
    // group id (peer id of the other party)
    pub group_id: Vec<u8>,
    // session type (1: audio, 2: video, 3: screen share)
    pub session_type: u32,
    // created at
    pub created_at: u64,
    // state 1: sent req (caller waiting), 2: received req (callee pending), 3: established
    pub state: u8,
    // SDP offer from caller (str0m JSON serialized SdpOffer)
    pub sdp_offer: Option<String>,
    // SDP answer from callee (str0m JSON serialized SdpAnswer)
                                ...
                                let proto_message = proto_rpc::RtcRpc {
                                    message: Some(proto_rpc::rtc_rpc::Message::RtcSessionResponse(
                                        proto_rpc::RtcSessionResponse {
                                            ...
                                            sdp_offer: session_req.sdp_offer.clone(),
                                        },
                                    )),
                                };
