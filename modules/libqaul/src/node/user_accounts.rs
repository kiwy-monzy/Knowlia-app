...
impl UserAccounts {
    pub fn init() {
        ...
        while let Some(user) = iter.next() {
            ...
            // log::info!("Added user '{}' to user accounts", user.name);
        }
    ...
    /// Initialize active users in router (call after router is initialized)
    pub fn init_active_users_in_router() {
        ...
        for user in &accounts.users {
            if user.active {
                crate::router::users::Users::add(
                    ...
                    false,
                    false,
                    user.profile_pic.clone(),
                    user.about.clone(),
                    user.reg_no.clone(),
                    user.college.clone(),
                );
                crate::router::connections::ConnectionTable::add_local_user(user.id);
                log::info!("Added active user '{}' to router", user.name);
            } else {
                log::info!(
                    "Skipping inactive user '{}' in router initialization",
                    user.name
                );
            }
        }
    ...
    /// create a new user account with user name and optional fields
    pub fn create(
        name: String,
                ...
                match user_accounts.message {
                                        ...
                                        proto::user_accounts::Message::DefaultUserAccount(
                                            proto::DefaultUserAccount {
                                                ...
                                                my_user_account: Some(proto::MyUserAccount {
                                                    ...
                                                    key_type,
                                                    key_base58,
                                                    profile_pic: user_account.profile_pic,
                                                    about: user_account.about,
                                                    reg_no: user_account.reg_no,
                                                    college: user_account.college,
                                                }),
                                            },
                                        ),
                                    ),
                    ...
                    Some(proto::user_accounts::Message::CreateUserAccount(create_user_account)) => {
                        ...
                        let user_account = Self::create(
                            ...
                            create_user_account.profile_pic,
                            create_user_account.about,
                            create_user_account.reg_no,
                            create_user_account.college,
                        );
