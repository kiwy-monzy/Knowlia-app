...
pub struct UserEntry {
    ...
    pub profile_pic: ::core::option::Option<::prost::alloc::string::String>,
    /// optional about text
    #[prost(string, optional, tag = "13")]
    pub about: ::core::option::Option<::prost::alloc::string::String>,
    /// optional registration number
    #[prost(string, optional, tag = "14")]
    pub reg_no: ::core::option::Option<::prost::alloc::string::String>,
    /// optional college
    #[prost(string, optional, tag = "15")]
    pub college: ::core::option::Option<::prost::alloc::string::String>,
}
