...
mod proto {
    include!("../../../../../modules/libqaul/src/rpc/protobuf_generated/rust/qaul.rpc.chat.rs");
}
mod proto_message {
    include!("../../../../../modules/libqaul/src/rpc/protobuf_generated/rust/qaul.net.messaging.rs");
}
mod proto_group {
    include!("../../../../../modules/libqaul/src/rpc/protobuf_generated/rust/qaul.net.group.rs");
}
mod proto_file {
    include!("../../../../../modules/libqaul/src/rpc/protobuf_generated/rust/qaul.net.chatfile.rs");
}
