...
mod proto {
    include!("../../../modules/libqaul/src/rpc/protobuf_generated/rust/qaul.rpc.rtc.rs");
}
mod proto_net {
    include!("../../../modules/libqaul/src/rpc/protobuf_generated/rust/qaul.net.rtc.rs");
}
        ...
        let proto_message = proto::RtcRpc {
            message: Some(proto::rtc_rpc::Message::RtcSessionRequest(
                proto::RtcSessionRequest {
                    ...
                    session_type: 1, // default to audio session
                    sdp_offer: "".to_string(),
                },
            )),
        };
